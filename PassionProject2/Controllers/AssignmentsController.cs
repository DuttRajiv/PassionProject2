...
namespace PassionProject2.Controllers
{
    public class AssignmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AssignmentId,AssignmentName,Course")] Assignment assignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AssignmentId,AssignmentName,Course")] Assignment assignment)
        {
